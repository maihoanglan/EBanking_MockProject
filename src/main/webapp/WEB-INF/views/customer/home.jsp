...
<html lang="en">
    <head>
        <title>E B@nking - Trang chủ</title>
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Xin chào, ${name}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3 col-sm-3">
                    <div class="sidebar">
                        <a class="active" href="<c:url value="/customer/trangchu"/>">Trang chủ</a>
