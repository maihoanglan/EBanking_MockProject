...
<html lang="en">
    <head>
        <title>E B@nking - Chuyển tiền ngoài ngân hàng thành công</title>
            ...
            <div class="row">
                ...
                <div class="mt-md-0 mt-sm-5 mt-4" style="width: 70%;">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td colspan="4">
                                <a href="<c:url value="/customer/externaltransfermoney"/>" class="btn btn-default" style="margin-left: 50px;">Tiếp tục giao dịch</a>
